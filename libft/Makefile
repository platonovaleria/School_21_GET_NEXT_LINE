...
#                                                 +#+#+#+#+#+   +#+            #
#    Created: 2019/09/12 13:52:01 by jbloodax          #+#    #+#              #
#    Updated: 2019/09/22 14:18:01 by jbloodax         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
SRCS = ft_atoi.c ft_bzero.c ft_isalnum.c ft_isalpha.c ft_isascii.c \
	   ...
	   ft_memcmp.c ft_memcpy.c ft_memdel.c ft_memalloc.c ft_memmove.c \
	   ...
	   ft_lstiter.c ft_lstnew.c ft_lstmap.c ft_freestr.c ft_sort_params.c \
	   ft_sqrt.c ft_count_words.c ft_len_word.c
OBJECTS = ft_atoi.o ft_bzero.o ft_isalnum.o ft_isalpha.o ft_isascii.o \
		  ...
		  ft_memcmp.o ft_memcpy.o ft_memdel.o ft_memalloc.o ft_memmove.o \
		  ...
		  ft_lstdel.o ft_lstdelone.o ft_lstiter.o ft_lstnew.o ft_lstmap.o \
		  ft_freestr.o ft_sort_params.o ft_sqrt.o ft_count_words.o \
		  ft_len_word.o
HEADER = libft.h
